...
/*
void ApiRequestHandler::MakeErrorApiGetResponse(StringResponse& response,
...
void ApiRequestHandler::MakeErrorApiAuthResponse(StringResponse& response, http::status status, std::string_view message) const {
    response.result(status);
    response.set(http::field::content_type, ContentType::APP_JSON);
